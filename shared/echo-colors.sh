# Reexport
export COLOR_OFF='\033[0m'       # Text Reexport
...
export BOLD_PURPLE='\033[1;35m'      # Purple
...
export UNDERLINE_PURPLE='\033[4;35m'      # Purple
...
export INTENSE_PURPLE='\033[0;95m'      # Purple
...
export BOLD_INTENSE_PURPLE='\033[1;95m'     # Purple
export BOLD_INTENSE_CYAN='\033[1;96m'       # Cyan
export BOLD_INTENSE_WHITE='\033[1;97m'      # White

# high intensity backgrounds
export ON_INTENSE_BLACK='\033[0;100m'   # Black
export ON_INTENSE_RED='\033[0;101m'     # Red
export ON_INTENSE_GREEN='\033[0;102m'   # Green
export ON_INTENSE_YELLOW='\033[0;103m'  # Yellow
export ON_INTENSE_BLUE='\033[0;104m'    # Blue
